...
try:
    path1 = 'W:/Documents/SCHOOL/Towson/2018-2022 -- DSc - Computer Security/6_Fall 2018/COSC 757 - Data Mining/Assignments/Classification Competition - 11-1/Final' + month + day + year + '-' + hour + min + '.csv'
    file1 = open(path1, "w+")
except:
    path1 = "Final" + month + day + year + "-" + hour + min + ".csv"
    file1 = open(path1, "w+")
