...
final = pd.read_csv('W:/Documents/SCHOOL/Towson/2018-2022 -- DSc - Computer Security/6_Fall 2018/COSC 757 - Data Mining/Assignments/Classification Competition - 11-1/test_data.csv')
...
finalTest = final.as_matrix(obs_bin)
...
finalTest = scaler.transform(finalTest)
...
rf_final = clf.predict(finalTest)
print(rf_final)

rf = pd.DataFrame(rf_final)
print(rf)
print(final['ID'])

'''
text_file = open('W:/Documents/SCHOOL/Towson/2018-2022 -- DSc - Computer Security/6_Fall 2018/COSC 757 - Data Mining/Assignments/Classification Competition - 11-1/' + modelName + month + day + year + '-' + hour + min + '.txt', "w+")
text_file.write("Accuracy")
acc = (sum(labels_test==labels_pred))/len(labels_pred)
text_file.write(str(acc))
...
df = pd.DataFrame(final['ID'])
frames = [df, rf]
result = pd.concat(frames)
print(result)

try:
    path1 = 'W:/Documents/SCHOOL/Towson/2018-2022 -- DSc - Computer Security/6_Fall 2018/COSC 757 - Data Mining/Assignments/Classification Competition - 11-1/PlayFinal' + month + day + year + '-' + hour + min + '.csv'
    file1 = open(path1, "w+")
except:
    path1 = "PlayFinal" + month + day + year + "-" + hour + min + ".csv"
    file1 = open(path1, "w+")

result.to_csv(file1, index=False)
file1.close()
