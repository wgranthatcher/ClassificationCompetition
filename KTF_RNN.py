...
def create_thousand_layer(data_width, neurons=25, optimizer='adam', dropout_rate=0.1, weight_constraint=0):
    ...
    #model.add(Dropout(dropout_rate))
    model.add(RNN(250, input_dim=data_width, kernel_initializer='normal', activation='relu'))
    model.add(Dropout(dropout_rate))
    model.add(RNN(100, kernel_initializer='normal', activation='relu'))
    model.add(Dropout(dropout_rate))
    model.add(RNN(10, kernel_initializer='normal', activation='relu'))
    model.add(Dropout(dropout_rate))
    model.add(RNN(7, kernel_initializer='normal', activation='softmax'))
    # Compile model
